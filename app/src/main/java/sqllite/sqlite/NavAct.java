...
public class NavAct extends AppCompatActivity implements
        ...
        mSQLSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mSQLDB != null){
                    ...
                    vals.put(DBContract.DemoTable.COLUMN_NAME_DEMO_LAT, (String)mLatText.getText());
                    vals.put(DBContract.DemoTable.COLUMN_NAME_DEMO_LONG, (String)mLonText.getText());
        ...
        if(mSQLDB != null) {
            try {
                ...
                mSQLCursor = mSQLDB.query(DBContract.DemoTable.TABLE_NAME,
                        new String[]{DBContract.DemoTable._ID,DBContract.DemoTable.COLUMN_NAME_DEMO_STRING, DBContract.DemoTable.COLUMN_NAME_DEMO_LONG,
                ...
                mSQLCursorAdapter = new SimpleCursorAdapter(this,
                        R.layout.sql_item,
                        mSQLCursor,
                        new String[]{DBContract.DemoTable.COLUMN_NAME_DEMO_STRING, DBContract.DemoTable.COLUMN_NAME_DEMO_LONG, DBContract.DemoTable.COLUMN_NAME_DEMO_LAT},
                        new int[]{R.id.sql_view_input, R.id.sql_listview_string, R.id.sql_listview_int},
                        0);
...
class SQLiteExample extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        testValues.put(DBContract.DemoTable.COLUMN_NAME_DEMO_STRING, "gfa");
        testValues.put(DBContract.DemoTable.COLUMN_NAME_DEMO_LONG, "abc");
        testValues.put(DBContract.DemoTable.COLUMN_NAME_DEMO_LAT, "Hello SQLite");
...
final class DBContract {
    ...
    public final class DemoTable implements BaseColumns {
        ...
        public static final String COLUMN_NAME_DEMO_STRING = "demo_input";
        public static final String COLUMN_NAME_DEMO_LAT = "demo_string";
        public static final String COLUMN_NAME_DEMO_LONG = "demo_int";
        ...
        public static final String SQL_CREATE_DEMO_TABLE = "CREATE TABLE " +
                ...
                DemoTable.COLUMN_NAME_DEMO_LONG + " VARCHAR(255));";

        public static final String SQL_TEST_DEMO_TABLE_INSERT = "INSERT INTO " + TABLE_NAME +
                " (" + COLUMN_NAME_DEMO_STRING + "," + COLUMN_NAME_DEMO_LAT + "," + COLUMN_NAME_DEMO_LONG + ") VALUES ('t', 'test', 123);";
